                ...
                <tbody>
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="edit_employee.php?id_user=<?=$data_user ['id_user']?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                        <a href="delete_employee.php?id_user=<?=$data_user ['id_user']?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>

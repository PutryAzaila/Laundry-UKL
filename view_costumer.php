            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <form method="POST" action="view_costumer.php" class="d-flex">
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="edit_costumer.php?id_costumer=<?=$data_costumer ['id_costumer']?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                        <a href="delete_costumer.php?id_costumer=<?=$data_costumer ['id_costumer']?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>

                                        <script> 
                                        onclick="return confirm('Are you sure want to delete this member?')">Delete</a> </script>
                                        </td>
                                    </tr>
                            <?php
                            }
